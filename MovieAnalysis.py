...
class MovieAnalysis:
    ...
    def __init__(self):
        ...
        # Data and MetaData
        self.movie_summaries = self._load_data('MovieData/MovieSummaries/plot_summaries.txt', 
                                               ['Wikipedia movie ID', 'Plot summary'])
        self.character_data = self._load_data('MovieData/MovieSummaries/character.metadata.tsv', 
                                              ['Wikipedia movie ID', 'Freebase movie ID', 'Movie release date', 
                                               ...
                                               'Freebase actor ID'])
        self.movie_data = self._load_data('MovieData/MovieSummaries/movie.metadata.tsv', 
                                          ['Wikipedia movie ID', 'Freebase movie ID', 'Movie name', 
                                           'Movie release date', 'Movie box office revenue', 'Movie runtime', 
                                           'Movie languages', 'Movie countries', 'Movie genres'])
        # Test Data
        self.tvtropes_clusters = self._load_data('MovieData/MovieSummaries/tvtropes.clusters.txt', 
                                                 ['Character type', 'Freebase character/actor map ID'])
        self.name_clusters = self._load_data('MovieData/MovieSummaries/name.clusters.txt', 
